...
Generated at: 18 August 2026, 09:11:46 (HKT)
Window: 24h

## Executive Dashboard

- Regime score: **67.0 / 100** (Moderate Risk-On)
...
| --- | --- | --- |
| Overall regime | 67.0 | Moderate Risk-On |
...
| Positive contributors |  | equity_trend=93.75, volatility=80.0, market_breadth=78.75, news_confirmation=65.62 |
...
- Sentiment counts: {'positive': 49, 'negative': 24, 'neutral': 7}
...
**4. Anthropic tells investors annualized revenue run rate climbed to $65 billion in July**
- Source: CNBC Markets
...
**7. BHP Annual Profit Rises On Record-High Copper Prices**
...
**8. Russia targets Danube port after one of Ukraine’s largest aerial attacks of the war**
...
**9. Japanese automakers vulnerable to one-two punch of Iran war, yen rally**
